                ...
                <div class="page-header">
                    <div class="page-header-content">
                        ...
                        <div class="page-header-actions">
                            <button class="btn btn-secondary btn-sm" onclick="windowsServerAuditorListInstance.showCreateReportModal()">
                                    ...
                                    <tr class="reports-table-row">
                                        ...
                                        <td>
                                            <div class="reports-table-actions" onclick="event.stopPropagation()">
                                                <button class="reports-table-action-btn reports-table-action-view" onclick="windowsServerAuditorListInstance.viewReport(${report.id})" title="${this.t('view')}">
                                                    <i class="fas fa-eye"></i>
                                                </button>
                                                <button class="reports-table-action-btn reports-table-action-delete" onclick="windowsServerAuditorListInstance.deleteReport(${report.id})" title="${this.t('delete')}">
